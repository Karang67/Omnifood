...
const SettingsCms = () => {
    ...
    const handleConfigSave = async (section, data) => {
        ...
        try {
            ...
            if (resData.success) {
                setAlert({ show: true, type: 'alert-success', message: 'Settings saved!' });
    ...
    const handleExport = (collection) => {
        // Trigger file download directly by opening URL
    ...
    return (
        <div style={{ padding: '20px 0' }}>
            ...
            {/* TAB 2: Delivery & Taxes */}
            {subTab === 'delivery' && (
                <form onSubmit={(e) => {
                    e.preventDefault();
                    // Merge both delivery and tax configs
