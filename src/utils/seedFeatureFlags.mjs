...
const featureDefinitions = [
  ...
  { name: 'Rider Dashboard', slug: 'rider-dashboard', module: 'Rider', parent: null, enabled: true, visible: true, roles: ['rider', 'admin'], apiEnabled: true, maintenance: false, beta: false, publicAccess: false, mobileEnabled: true, desktopEnabled: true, readOnly: false, order: 1 },
  { name: 'Order Accept/Reject Controls', slug: 'rider-actions', module: 'Rider', parent: null, enabled: true, visible: true, roles: ['rider', 'admin'], apiEnabled: true, maintenance: false, beta: false, publicAccess: false, mobileEnabled: true, desktopEnabled: true, readOnly: false, order: 2 },
  { name: 'Live Location Tracking', slug: 'rider-location', module: 'Rider', parent: null, enabled: true, visible: true, roles: ['rider', 'admin'], apiEnabled: true, maintenance: false, beta: false, publicAccess: false, mobileEnabled: true, desktopEnabled: true, readOnly: false, order: 3 },
